...
async function main() {
  ...
  // delist_buy_token_offer
  // (buyer: &signer, market_address:address, market_name: String, creator: address, collection_name: String, offer_id: u64)
  const payload = {
    function: `${MARKET_ADDRESS}::marketplace::delist_collection_buy_token_offer`,
