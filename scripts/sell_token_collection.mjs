...
async function main() {
  ...
  // sell_token
  // (seller: &signer, market_address: address, market_name: String, creator: address, collection: String, name: String, property_version: u64, offer_id: u64)  
  const payload = {
    function: `${MARKET_ADDRESS}::marketplace::sell_token_collection`,
