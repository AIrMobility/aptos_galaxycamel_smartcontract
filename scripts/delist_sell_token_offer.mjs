...
async function main() {
  const sellerPrivateKey = '0x2d8a6dccbd87d61f7e18dd8980d37569a78ae3afdeb54bffc885176ec9bafaa1';
  ...
  // seller: &signer, market_address:address, market_name: String, creator: address, collection: String, name: String, property_version: u64
  const payload = {
    function: `${MARKET_ADDRESS}::marketplace::delist_sell_token_offer`,
